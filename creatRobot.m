function [robot,startT]= creatRobot()
    ...
    L1=Link([  0,    d(1),       a(1),    alph(1),      0, 0],'standard');
    L2=Link([  0,    d(2),       a(2),    alph(2),      0, 0],'standard');
    L3=Link([  0,    d(3),       a(3),    alph(3),      0, 0],'standard');
    L4=Link([  0,    d(4),       a(4),    alph(4),      0, 0],'standard');
    L5=Link([  0,    d(5),       a(5),    alph(5),      0, 0],'standard');
    L6=Link([  0,    d(6),       a(6),    alph(6),      0, 0],'standard');
